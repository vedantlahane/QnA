...
const InputSection: React.FC = () => {
  ...
  return (
    <footer className="sticky bottom-0 z-30 border-t border-white/10 bg-[#0f1420]/80 backdrop-blur-xl px-6 pb-5 pt-4">
      <AnimatePresence>
        {files.length > 0 && (
          <motion.div
      ...
      <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-[#0f1420]/60 px-4 py-3">
        <motion.button
          type="button"
        ...
        <input
          ...
          placeholder="I want to transfer 1 btc"
